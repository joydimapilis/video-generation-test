...
colors:
  ...
  butter: "#F7DF77"
  text-light: "#9A9A9A"
  accent-light: "rgba(39, 91, 232, 0.08)"
  accent-medium: "rgba(39, 91, 232, 0.15)"
  border: "rgba(39, 91, 232, 0.2)"
  card-bg: "rgba(39, 91, 232, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  ...
  body:    { fontFamily: "Space Grotesk", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
...
## Mapping correction
The brand mapper placed butter yellow into muted text. Corrected muted text to#606660 for readable contrast; butter is a surface accent, never small text. Mobile UI uses large Space Grotesk labels.
