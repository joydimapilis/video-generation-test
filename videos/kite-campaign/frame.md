...
colors:
  ...
  text-muted: "#105DA8"
  text-light: "#9A9A9A"
  accent-light: "rgba(52, 123, 205, 0.08)"
  accent-medium: "rgba(52, 123, 205, 0.15)"
  border: "rgba(52, 123, 205, 0.2)"
  card-bg: "rgba(52, 123, 205, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Onest** (display) / **Manrope** (body); ignore any preset font name lingering in prose.
...
The fictional Relay campaign has its own independent brand inside client-output surfaces: cream #F4F1E8, navy #182B32, lime #D4F578. This deliberate nested identity separates Kite interface from campaign output. Use Onest throughout. Outer Kite field may use full brand blue with white type; white cards supply contrast. Supporting neutral text on white is #616061 (captured). Minimum key narrative text 32px; hero display up to 124px. No shadows, gradients or gratuitous loops.
