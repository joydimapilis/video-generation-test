...
- **Fonts** — already set to **Source Serif 4** (display) / **Inter** (body); ignore any preset font name lingering in prose.
...
@font-face{font-family:"Source Serif 4";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/SourceSerif4-Regular.ttf") format("truetype");}
</style>
```
