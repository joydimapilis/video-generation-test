...
colors:
  ...
  text-muted: "#625F59"
  text-light: "#9A9A9A"
  accent-light: "rgba(255, 109, 45, 0.08)"
  accent-medium: "rgba(255, 109, 45, 0.15)"
  border: "rgba(255, 109, 45, 0.2)"
  card-bg: "rgba(255, 109, 45, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
Source-derived Slack surfaces: #191A1D main, #141317 sidebar, #29282D borders, #C7C7CB secondary, #FFFFFF primary. UI Lato 400/700; brand Onest. No shadow needed. Editorial cream #F6F4EE. Headline 72px, body 32px, metadata minimum 22px. Exact UI sentences are content, not duplicated narration. Caption band below y=900 is clear. No new agent delegation; inline serial fallback executes frame-worker contract.
