...
description: >
  ...
  accent, the three-step gray text ladder, Onest (display/numerals/chrome) + Onest (body),
...
typography:
  # — reading ramp (Onest body + Onest chrome) —
  body:    { fontFamily: "Onest", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Onest", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Onest", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Onest", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Onest, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Onest", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Onest", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Onest", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Onest", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Onest", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Onest", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Onest", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **Onest** (display) / **Onest** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Onest** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Onest** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Onest** (display/numerals/chrome) + **Onest** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Onest body 0.85cqw muted; Onest eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Onest `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Onest 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Onest `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Onest label + muted desc + optional
...
blockquote, cite. **Focal** a Onest `blockquote` near-black under a 15%-opacity cobalt
...
Onest body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Onest `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Onest 400 muted, line 1.6.
...
- **Type** — Onest headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Onest body muted line 1.6; ≥1.4cqw floor.
...
- **Onest + Onest via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
...
```html
<style>
@font-face{font-family:"Onest";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/Onest-Regular.woff2") format("woff2");}
</style>
```


## Kite storyboard overrides — authoritative for this project

Preset blue-professional supplies restraint and card hierarchy only. The automatic mapper initially chose homepage blue; corrected manually to the official newsroom orange #FF6D2D and night #0E0E0E. White #FFFFFF canvas, #535353 supporting text, #D9D9D9 rules, #FFF0E5 / #FFF5EE tints. Captured Onest is the sole font; assets/Onest.woff2 contains the Latin glyphs. Orange buttons use dark text for contrast. No preset decoration, numerical claims, green success states or progress bar.

Canvas 1080×1920. Essential rectangle x108–972, y690–1230. Headings 54–58px; UI 30–42px; supporting labels 26–29px; captions 32px. These sizes are provisional pending mobile readability review. End-card logo is original newsroom artwork, not redrawn. Approval pending.
