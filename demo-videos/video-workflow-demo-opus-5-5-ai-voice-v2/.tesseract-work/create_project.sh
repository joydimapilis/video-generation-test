...
P=${1:-Video-Workflow-Demo-Opus-5.5-AI-Voice-v2.tsrct}
R=$PWD
...
# AI narration: one Kokoro v1.0 (af_heart) file per script sentence, 0.92x, mastered +6.5 dB with a peak limiter (see Assets/SOURCES.md)
