"""Synthesize every script sentence locally with Kokoro v1.0 (voice af_heart, 0.92x)."""
import json, os, sys
import kokoro_onnx, soundfile as sf
sys.path.insert(0, os.path.dirname(__file__))
from script_lines import STEPS
C = os.path.expanduser("~/.cache/hyperframes/tts")
VOICE, SPEED = "af_heart", 0.92   # same voice and speed as the Save-the-Learnings AI-voice reference
