"""The supplied script, verbatim, split into sentences. Sent to the voice model exactly as
written (no pronunciation hints), matching the Save-the-Learnings AI-voice reference."""
STEPS = [
 ("V1", [
  ("Hi everyone.", None),
 ...
 ("V4b", [
  ...
  ("For this project, the system chose HyperFrames because the video needed precise text, UI, and layout instead of generative footage.", None)]),
 ("V4c", [
 ...
 ("V6", [
  ("For every finished video, the system creates its own reverse-engineering document.", None),
