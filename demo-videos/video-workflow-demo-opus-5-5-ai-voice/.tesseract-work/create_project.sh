...
P=${1:-Video-Workflow-Demo-Opus-5.5-AI-Voice.tsrct}
R=$PWD
...
# AI narration: one Kokoro v1.0 (af_heart) file per script sentence, compressed/limited (see Assets/SOURCES.md)
